...
DB_PATH = os.environ.get('DB_PATH', 'dokkani.db')
...
def seed_categories(c):
    ...
    c.executemany('INSERT INTO categories (name,icon,sort) VALUES (?,?,?)', cats)
...
def seed_subcategories(c):
    ...
    c.executemany('INSERT INTO subcategories (name,icon,category_id) VALUES (?,?,?)', subs)
